            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm h-40"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    value={formData.certifications[0].name}
                    onChange={handleChange}
                ...
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    value={formData.certifications[0].issuingOrganization}
                    onChange={handleChange}
                ...
                <div>
                  ...
                  <input
                    ...
                    type="date"
                    value={formData.certifications[0].dateIssued}
                    onChange={handleChange}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    type="date"
                    value={formData.certifications[0].expirationDate}
                    onChange={handleChange}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  />
                </div>
